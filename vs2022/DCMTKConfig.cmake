...
set(DCMTK_CMAKE_CXX_FLAGS_DEBUG /MTd /Zi /Ob0 /Od /RTC1 -DDEBUG)
set(DCMTK_CMAKE_CXX_FLAGS_RELEASE /MT /O2 /Ob2 /DNDEBUG)
set(DCMTK_CMAKE_CXX_FLAGS_MINSIZEREL /MT /O1 /Ob1 /DNDEBUG)
set(DCMTK_CMAKE_CXX_FLAGS_RELWITHDEBINFO /MT /Zi /O2 /Ob1 /DNDEBUG)

set(DCMTK_CMAKE_C_FLAGS_DEBUG /MTd /Zi /Ob0 /Od /RTC1 -DDEBUG)
set(DCMTK_CMAKE_C_FLAGS_RELEASE /MT /O2 /Ob2 /DNDEBUG)
set(DCMTK_CMAKE_C_FLAGS_MINSIZEREL /MT /O1 /Ob1 /DNDEBUG)
set(DCMTK_CMAKE_C_FLAGS_RELWITHDEBINFO /MT /Zi /O2 /Ob1 /DNDEBUG)
...
SET_AND_CHECK(DCMTK_TARGETS "C:/__Dev/dcmtk-3.6.7/build/DCMTKTargets.cmake")

####### Expanded from @DCMTK_CONFIG_CODE@ #######
list(APPEND DCMTK_INCLUDE_DIRS "C:/__Dev/dcmtk-3.6.7/build/config/include")
